        ...
        <div className="container-full mx-auto min-h-screen bg-custom-black">
            ...
            <main className="lg:w-6/12 md:w-8/12 w-10/12 mx-auto my-3">
                ...
                <section className="md:2-6/12 w-10/12 mx-auto text-center py-5">
                    <button className="inline-block text-white rounded-full border border-slate-600 m-0 pb-1 px-2 text-sm mx-1">
                        &lt;
                    </button>
                    <button className="inline-block text-white rounded-full border border-slate-600 m-0 pb-1 px-2 text-sm mx-1">
                        1
                    </button>
                    <button className="inline-block text-white rounded-full border border-slate-600 m-0 pb-1 px-2.5 text-sm mx-1">
                        2
                    </button>
                    <button className="inline-block text-white rounded-full border border-slate-600 m-0 pb-1 px-2.5 text-sm mx-1 bg-indigo-500">
                        3
                    </button>
                    <button className="inline-block text-white rounded-full border border-slate-600 m-0 pb-1 px-2.5 text-sm mx-1">
                        4
